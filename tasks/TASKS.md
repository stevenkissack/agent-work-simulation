...
1. **Support issue** - Tasks are showing in the wrong order
   ...
   - Deliverable: Fix the bug, then summarise it for Support in [`../output.md`](../output.md).
...
2. **New feature (POC)** - Solving multi-site visibility problems
   - What: Build a prominent Home-screen card showing overdue and top-priority tasks across all
     sites.
   - Deliverable: A demo-able POC.
   - More information: [`design_jam_notes.md`](./design_jam_notes.md)

3. **RFC review (stretch goal)** - A teammate's plan to implement offline sync support
...
Put your Support update and RFC review in the one file: [`../output.md`](../output.md).
